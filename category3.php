...
<script type="text/javascript">
	$(document).on("click", ".identifyingClass", function () {
	 ...
	 document.getElementById("item_image").src = "picture/Category_3/" + image;
...
<body>
	...
	$sql = "SELECT id, item_name, quantity, price,image FROM item where category='health'";
...
<?php endif; ?>
	...
	<div class="thumbnail">
	  <img id="product-image" class="identifyingClass img-responsive scale" src="picture/Category_3/<?php echo $row['image']; ?>"
